...
class GoogleController extends Controller
{
    public function redirectToGoogle()
    {
        ...
        return Socialite::driver('google')->scopes(['https://www.googleapis.com/auth/youtube.upload', 'https://www.googleapis.com/auth/youtube.readonly','profile','email'])->redirect();
    }
