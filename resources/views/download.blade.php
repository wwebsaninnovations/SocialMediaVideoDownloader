...
<body>
    <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-6">
        <form action="{{ route('download') }}" method="POST" class="bg-white shadow-md rounded-lg p-8 w-full max-w-md">
            @csrf
            <h2 class="text-2xl font-bold mb-6 text-center">Download Youtube Video</h2>
            <h3 class="text-1xl font-bold mb-6 text-center">Laravel Tailwind</h3>
            <input type="text" name="url" placeholder="Enter Instagram video URL"
